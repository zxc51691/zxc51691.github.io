...
<div class="flex flex-col lg:flex-row min-h-screen bg-gray-100">
    ...
    <div class="flex-1 p-4 lg:p-8">
        <div class="max-w-2xl mx-auto">
            <h2 class="text-3xl font-medium mb-8 text-center">Help</h2>
            
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-2xl font-medium mb-6 text-center">Contact Us<br>For Help</h3>
                
                <form class="space-y-4">
                    <div>
                        <label class="block text-gray-700 mb-2">Name</label>
                        <input type="text" class="w-full p-2 border rounded-lg" placeholder="Value">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" class="w-full p-2 border rounded-lg" placeholder="Value">
                    </div>
                    
                    <div>
                        <label class="block text-gray-700 mb-2">Message</label>
                        <textarea class="w-full p-2 border rounded-lg h-32" placeholder="Value"></textarea>
                    </div>
