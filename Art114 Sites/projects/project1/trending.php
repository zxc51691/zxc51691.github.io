...
<div class="flex flex-col lg:flex-row min-h-screen bg-gray-100">
            ...
            <nav class="space-y-6">
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="trending.php" class="text-red-500 hover:text-red-600">Trending</a></li>
                    </ul>
                </div>
    ...
    <div class="flex-1 p-4 lg:p-8">
        <!-- Trending Title -->
        <h2 class="text-2xl lg:text-3xl font-medium mb-4 lg:mb-8 text-center">Trending</h2>

        <!-- Posts -->
        <div class="bg-white rounded-lg shadow-lg mb-8 max-w-2xl mx-auto">
            <div class="p-4">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-500">Just landed this new trick! 🛹</div>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <img src="images/trendfire-01.png" class="w-6 h-6 bg-white-200 rounded">
                        <button class="text-gray-400 hover:text-gray-600">•••</button>
                    </div>
                </div>
                
                <img src="/api/placeholder/800/600" alt="Skateboarding trick" class="rounded-lg w-full">
                ...
                <div class="mt-4 flex items-center space-x-4">
                    ...
                    <a href="comments.php" class="text-gray-500 hover:text-gray-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                    </svg>
                    </a>
        ...
        <!-- Additional Posts with same structure -->
        <?php
        for ($i = 0; $i < 2; $i++) {
            echo '<div class="bg-white rounded-lg shadow-lg mb-8 max-w-2xl mx-auto">
                <div class="p-4">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center space-x-2">
                            <img src="images/ProfIcon-01.png" alt="Profile" class="w-10 h-10 rounded-full object-cover">
                            <div>
                                ...
                                <div class="text-sm text-gray-500">Post Caption</div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <img src="images/trendfire-01.png" class="w-6 h-6 bg-white-200 rounded">
                    ...
                    <img src="/api/placeholder/800/600" alt="Post image" class="rounded-lg w-full">
